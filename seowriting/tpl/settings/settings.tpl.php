	...
	<tbody>
		<tr>
			...
			<td>
				...
				<div class="seowriting-desc"><?php echo __('It is important to note that this setting is exclusively designed for use with Schema markup for the FAQ section, ensuring more effective search engine interaction for your published content.', 'seowriting'); ?></div>
			</td>
		</tr>
	</tbody>
</table>
